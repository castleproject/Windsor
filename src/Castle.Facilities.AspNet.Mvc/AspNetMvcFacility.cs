...
namespace Castle.Facilities.AspNet.Mvc
{
	...
	public class AspNetMvcFacility : AbstractFacility, ISupportFacility
	{
		...
		protected override void Init()
		{
			...
			controllerFactory = new AspNetMvcControllerFactory(this);
			controllerFactory.AddControllerAssemblies(controllerAssemblies);
