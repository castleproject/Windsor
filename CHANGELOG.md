...
- passing arguments to ILazyComponentLoader (see breakingchanges.md)
...
- Changed IModelInterceptorSelector's signature and behavior (see breakingChanges.md for details)
- removed IProxyHook interface (see breakingchanges.md)
