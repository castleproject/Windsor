...
namespace Castle.Services.Transaction.Lifestyles
{
	...
	/// 	the main lifestyle is <see cref = "PerTransactionLifestyleManager" />,
	...
	/// <summary>
	/// Hybrid lifestyle manager,
	/// the main lifestyle is <see cref="PerTopTransactionLifestyleManager"/>,
	/// and the secondary lifestyle is <see cref="TransientLifestyleManager"/>
	/// </summary>
